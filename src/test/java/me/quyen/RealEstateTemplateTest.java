...
@SpringBootTest
public class RealEstateTemplateTest {
    /**
    ...
    public void parserHtmlRealEstateTemplateByJsoupLibraryTest() throws IOException {
        ...
        String baseInputPath = "src/main/resources/templates/origins/real-estate";
        String baseOutputPath = "src/main/resources/templates/real-estate";
