...
@SpringBootTest
public class ElectroSellTemplateTest {
    /**
    ...
    public void parserHtmlRealEstateTemplateByJsoupLibraryTest() throws IOException {
        ...
        String baseInputPath = "src/main/resources/templates/origins/electro-sell";
        String baseOutputPath = "src/main/resources/templates/electro-sell";
