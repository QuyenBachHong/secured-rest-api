package me.quyen.dbconfigs.employee;
...
@org.springframework.context.annotation.PropertySource(
        "classpath:databases/employee-application.properties"//NOTE!!
) ////NOTE!!
@org.springframework.data.jpa.repository.config.EnableJpaRepositories(
        basePackages = "me.quyen.repositories.employee", //NOTE!!
        entityManagerFactoryRef = "employeeEntityManagerFactory",//NOTE!!
        transactionManagerRef = "employeeTransactionManager"//NOTE!!
)
@org.springframework.transaction.annotation.EnableTransactionManagement
public class EmployeeHikariCPoolConfig {
    private final String BEAN_PREFIX = "employee";//NOTE!!
    private final org.springframework.orm.jpa.vendor.Database DATABASE
            = org.springframework.orm.jpa.vendor.Database.H2;//NOTE!!
    ...
    private HikariDataSource getHikariDataSource(
        ...
        hikariDataSource.setMaximumPoolSize(
                Integer.parseInt(env.getProperty("spring.employee.datasource.hikari.maximumPoolSize","10"))
        );
        hikariDataSource.setMinimumIdle(
                Integer.parseInt(env.getProperty("spring.employee.datasource.hikari.minimumIdle","10"))
        );
        hikariDataSource.setMaxLifetime(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.maxLifetime","1800000"))
        ); // 60 min
        hikariDataSource.setIdleTimeout(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.idleTimeout","600000"))
        ); // 30 min
        hikariDataSource.setConnectionTimeout(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.connectionTimeout","30000"))
        ); //10 min
        hikariDataSource.setAutoCommit(
                Boolean.getBoolean(env.getProperty("spring.employee.datasource.hikari.autoCommit","false"))
        );
        hikariDataSource.setPoolName(env.getProperty("spring.employee.datasource.hikari.poolName",
                "DEFAULT_H2DB_POOL") );
        ...
        hikariDataSource.setValidationTimeout(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.validationTimeout","10000"))
        );
        hikariDataSource.setKeepaliveTime(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.keepaliveTime","300000"))
        );
        hikariDataSource.setLeakDetectionThreshold(
                Long.parseLong(env.getProperty("spring.employee.datasource.hikari.leakDetectionThreshold","10000"))
        );
        hikariDataSource.addDataSourceProperty("cachePrepStmts",
                env.getProperty("spring.employee.datasource.hikari.cachePrepStmts","true"));
        hikariDataSource.addDataSourceProperty("prepStmtCacheSize",
                env.getProperty("spring.employee.datasource.hikari.prepStmtCacheSize","250"));
        hikariDataSource.addDataSourceProperty("prepStmtCacheSqlLimit",
                env.getProperty("spring.employee.datasource.hikari.prepStmtCacheSqlLimit","2048"));
        hikariDataSource.addDataSourceProperty("useServerPrepStmts",
                env.getProperty("spring.employee.datasource.hikari.useServerPrepStmts","true"));
        hikariDataSource.addDataSourceProperty("useLocalSessionState",
                env.getProperty("spring.employee.datasource.hikari.useLocalSessionState","true"));
        hikariDataSource.addDataSourceProperty("rewriteBatchedStatements",
                env.getProperty("spring.employee.datasource.hikari.rewriteBatchedStatements","true"));
        hikariDataSource.addDataSourceProperty("cacheResultSetMetadata",
                env.getProperty("spring.employee.datasource.hikari.cacheResultSetMetadata","true"));
        hikariDataSource.addDataSourceProperty("cacheServerConfiguration",
                env.getProperty("spring.employee.datasource.hikari.cacheServerConfiguration","true"));
        hikariDataSource.addDataSourceProperty("elideSetAutoCommits",
                env.getProperty("spring.employee.datasource.hikari.elideSetAutoCommits","true"));
        hikariDataSource.addDataSourceProperty("maintainTimeStats",
                env.getProperty("spring.employee.datasource.hikari.maintainTimeStats","false"));
...
//    public org.springframework.jdbc.datasource.init.DataSourceInitializer employeeDataSourceInitializer(
...
//        databasePopulator.addScript(new org.springframework.core.io.ClassPathResource("sql/employee-data.sql"));
//        dataSourceInitializer.setDatabasePopulator(databasePopulator);
//        dataSourceInitializer.setEnabled(env.getProperty("spring.employee.datasource.initialize", Boolean.class,
//                false));
